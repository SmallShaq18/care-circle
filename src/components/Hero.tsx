...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#1a2e4d] text-white px-6 pt-14 pb-10 md:pt-20 md:pb-14">
      <div className="max-w-2xl mx-auto text-center relative z-10">
        <p className="text-[#c5a880] text-[11px] md:text-xs font-medium tracking-[0.2em] mb-5 uppercase font-sans">
        ...
        <a
          href="#support-form"
          className="inline-flex items-center gap-2.5 bg-[#c5a880] text-[#1a2e4d] font-semibold px-7 py-3.5 rounded-full hover:bg-[#d4bc93] transition-colors shadow-[0_8px_30px_rgba(197,168,128,0.2)] active:scale-[0.98] text-[15px]"
        >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30">
        <div className="absolute top-[-20%] left-[10%] w-[32rem] h-[32rem] bg-[#c5a880]/20 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-[-30%] right-[5%] w-[24rem] h-[24rem] bg-[#c5a880]/15 rounded-full blur-[80px]"></div>
      </div>
    </section>
  )
}
