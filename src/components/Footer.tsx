export default function Footer() {
  return (
    <footer className="bg-[#1a2e4d] text-white px-6 py-10 md:py-12 border-t border-white/[0.06]">
      ...
      <div className="max-w-5xl mx-auto mt-8 pt-6 border-t border-white/[0.06] text-[0.75rem] text-white/20 font-light">
