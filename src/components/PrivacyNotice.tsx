export default function PrivacyNotice() {
  return (
    <section className="bg-white px-6 py-14 md:py-16 border-t border-[#1a2e4d]/5">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-[1.6rem] md:text-[1.85rem] font-semibold text-[#1a2e4d] mb-5 tracking-tight" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
